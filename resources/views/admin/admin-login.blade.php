...
<head>
  ...
  <title>Admin Cakebakery - Login</title>
  <base href="{{asset('')}}">
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="{{route('admin.login.submit')}}" method="POST">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" placeholder="Nhập Username" required>
                    </div>
                    <div class="form-group">
